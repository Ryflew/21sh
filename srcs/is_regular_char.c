...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/29 14:53:46 by vdarmaya          #+#    #+#             */
/*   Updated: 2018/11/29 14:55:04 by vdarmaya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (bs || (lexer->bqt && (c != '`' || lexer->bkt)) || \
		(lexer->par && (c != ')' || lexer->bkt))) ? 1 : 0;
}
...
char	is_var_op(char c1, char c2)
{
	return (c1 == '$' && ft_isalnum(c2)) ? 1 : 0;
}

char	is_equal(t_lexer *lexer, char c, int i)
{
